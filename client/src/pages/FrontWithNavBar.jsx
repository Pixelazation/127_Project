export default function FrontWithNavBar() {
  return (
    <div className="bg-[#E6F7FF] flex w-[1363px] box-sizing-border">
      <div className="relative flex flex-col items-center w-[1440px] h-[fit-content] box-sizing-border">
        <div className="bg-[#92C1F0] relative m-[0_0_136px_0] flex p-[0_81px_0_64.9px] w-[1440px] box-sizing-border">
          <div className="relative flex flex-row justify-between w-[1294.1px] h-[fit-content] box-sizing-border">
            <div className="m-[9px_18px_9px_0] inline-block w-[1171.1px] break-words font-['JejuMyeongjo'] font-normal text-[36px] text-[#000000]">
            Care and Cure Hub
            </div>
            <div className="flex flex-row w-[105px] box-sizing-border">
              <div className="bg-[#D9D9D9] m-[24px_46px_28px_0] w-[1px] h-[2px]">
              </div>
        ...
        <div className="m-[0_39px_0_0] flex flex-row w-[763px] box-sizing-border">
          <div className="relative m-[0_191px_0px_0] flex p-[72.9px_0_0_0] w-[286px] box-sizing-border">
            <div className="rounded-[35px] relative flex p-[156.2px_3.3px_58.9px_0] w-[286px] h-[fit-content] box-sizing-border">
              <div className="rounded-[20px] bg-[#B5DAFF] absolute left-[50%] top-[0px] translate-x-[-50%] w-[286px] h-[235.1px]">
              </div>
              <div className="rounded-[35px] border-[1px_solid_#000000] bg-[#92C1F0] absolute left-[50%] top-[134px] translate-x-[-50%] w-[162px] h-[65.7px]">
              </div>
      ...
      <div className="rounded-[2px] border-[1px_solid_#92C1F0] bg-[#E6F7FF] absolute top-[50px] right-[4px] flex flex-col items-center p-[14px_0_20px_0] w-[173px] box-sizing-border">
        <div className="m-[0_0_9px_0] flex flex-row w-[fit-content] box-sizing-border">
          <div className="bg-[url('assets/images/Image3.png')] bg-[50%_50%] bg-cover bg-no-repeat m-[0_16.9px_0_0] w-[29.7px] h-[34px]">
          </div>
          <div className="m-[10.1px_0_4.9px_0] inline-block break-words font-['Droid_Sans','Roboto_Condensed'] font-normal text-[16px] text-[#000000]">
          Add Service
          </div>
        </div>
        <div className="m-[0_4.1px_0_0] flex flex-row w-[fit-content] box-sizing-border">
          <div className="bg-[url('assets/images/Image4.png')] bg-[50%_50%] bg-cover bg-no-repeat m-[0_18.6px_0_0] w-[28px] h-[32px]">
          </div>
          <div className="m-[10px_0_3px_0] inline-block break-words font-['Droid_Sans','Roboto_Condensed'] font-normal text-[16px] text-[#000000]">
          Add Doctor
          </div>
        </div>
      </div>
